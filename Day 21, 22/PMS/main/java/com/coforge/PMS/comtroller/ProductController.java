package com.coforge.PMS.comtroller;
...
public class ProductController {
	...
	public ResponseEntity<?> findBySupplierId(@PathVariable("supplierId") int supplierId) {
		ResponseEntity<?> responseEntity = null;
		SupplierDTO supplier = service.getSupplierBySupplierId(supplierId);
		if (supplier != null)
	...
	public ResponseEntity<?> getProductBySupplier(@PathVariable("pid") int pid) {

		ResponseEntity<String> responseEntity = null;
		ProductDTO productDTO = new ProductDTO();
		Product product = service.findByPid(pid).get();
		SupplierDTO supplier = service.getSupplierBySupplierId(product.getSupplierId());
