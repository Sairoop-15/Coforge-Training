...
public class EmployeeController {
	...
	public ResponseEntity<String> saveEmployee(@NotNull @Valid @RequestBody Employee employee) {
		System.out.println("Request Coming to Backend!");
	...
	public ResponseEntity<String> updateEmployee(@NotNull @Valid @PathVariable("eid") int eid,
	...
	public ResponseEntity<String> deleteByEid(@NotNull @Valid @PathVariable("eid") int eid) {
		System.out.println("Delete Endpoint Accessed");
	...
	// Rest Endpoints for Feign Client Department

	@GetMapping("/employees/department/{deptNo}")
	public ResponseEntity<?> findDepartmentById(@PathVariable("deptNo") int deptNo) {
		ResponseEntity<?> responseEntity = null;
		DepartmentDTO department = service.findDepartmentByDeptNo(deptNo);
		if (department != null)
	...
	@GetMapping("/employees/{empId}/department")
	public ResponseEntity<EmployeeDTO> findEmployeeDetails(@PathVariable("empId") int empId) {
		...
		DepartmentDTO department = service.findDepartmentByDeptNo(employee.getDeptNo());
