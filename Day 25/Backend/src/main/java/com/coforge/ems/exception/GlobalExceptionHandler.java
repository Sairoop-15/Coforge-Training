...
@RestControllerAdvice // handle global exception
public class GlobalExceptionHandler {
	...
	public ResponseEntity<?> handleException(Exception e) {
		return new ResponseEntity<>(e.getMessage() != null ? e.getMessage() : environment.getProperty("ems.db.failed"), HttpStatus.BAD_REQUEST);
	}
}
